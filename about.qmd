...
This list does NOT aim to be a complete list of all existing GIS data (impossible task) but it IS a collection of what have been used recently by some groups in [FRB-CESAB](https://www.fondationbiodiversite.fr/en/about-the-foundation/le-cesab/). 

This list does NOT contain biodiversity field observations or traits data but it only list GIS data (either polygons, grid or raster).
...
| Time               | For time series, provide the extent and the frequency.                                                       |
|                    | When averaging value over a time period, indicate only the middle of the time period.                        |
| Provider *         | Organization responsible for the data storage or author names of the publication                             |
| Status             | Information related to the license of the dataset.                                                           |
|                    | In 5 categories: Open to all / Open to academics / Open to registered users / Restricted / Private           |
...
If you see mistakes, want to suggest changes, or add new dataset, please [create an issue](https://github.com/FRBCesab/terrameta/issues/new) on the source repository.
